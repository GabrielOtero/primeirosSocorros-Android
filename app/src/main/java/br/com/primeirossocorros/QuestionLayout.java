...
public class QuestionLayout extends ConstraintLayout {
    ...
    private QuestionFeedbackListenerImpl listener;
    ...
    public void setInfo(String questionLabel, String opt1, String opt2, String opt3, String opt4,
                        int correctOpt, QuestionFeedbackListenerImpl listener) {
    ...
    public void setInfo(String questionLabel, String opt1, String opt2, String opt3, String opt4,
                        int correctOpt) {
        setInfo(questionLabel, opt1, opt2, opt3, opt4, correctOpt, null);
    }
